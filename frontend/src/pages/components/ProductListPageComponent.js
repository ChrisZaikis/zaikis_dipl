      ...
      <Row>
        <Col md={3}>
          <ListGroup className="shadow p-3 mb-5 bg-white rounded">
            <ListGroup.Item className="shadow p-3 mb-3 bg-white rounded">
            ...
            <ListGroup.Item>
              <Button variant="warning  border-danger" onClick={handleFilters}>
                Φίλτρο
              </Button>{" "}
              {showResetFiltersButton && (
                <Button onClick={resetFilters} variant="info  border-danger">
                  Επαναφορά φίλτρων
                </Button>
              )}
            </ListGroup.Item>
        ...
        <Col md={9}>
          {loading ? (
            <h1>Φόρτωση προϊόντων ....</h1>
          ) : error ? (
            <h1>Σφάλμα κατά τη φόρτωση προϊόντων. Δοκιμάστε ξανά αργότερα.</h1>
          ) : (
