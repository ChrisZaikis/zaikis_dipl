...
const reviews = [
  {
    comment:
      "Τέλειο προϊόν αξηζει.Το αγοράσα πριν έξι(6) μήνες και είμαι πολύ Ευχαριστημένος.",
    rating: 5,
    user: { _id: ObjectId(), name: "Νίκος Γ." },
  },
  {
    comment:
      "Φοβερό προϊόν αξηζει.Το αγοράσα προχθές και είμαι πολύ Ευχαριστημένη.",
    rating: 5,
    user: { _id: ObjectId(), name: "Μαρία Β." },
  },
  {
    comment:
      "Πολυ Καλό προϊόν αξηζει.Το αγοράσα πρίν έναν χρόνο και είμαι πολύ Ευχαριστημένος.",
    rating: 5,
