...
const reviews = [
  {
    comment:
      "Τέλειο προϊόν αξίζει.Το αγοράσα πριν έξι(6) μήνες και είμαι πολύ Ευχαριστημένος.",
    rating: 5,
    user: { _id: ObjectId(), name: "Νίκος Γ." },
  },
  {
    comment:
      "Φοβερό προϊόν αξίζει.Το αγοράσα προχθές και είμαι πολύ Ευχαριστημένη.",
    rating: 5,
    user: { _id: ObjectId(), name: "Μαρία Β." },
  },
  {
    comment:
      "Πολυ Καλό προϊόν αξίζει.Το αγοράσα πρίν έναν χρόνο και είμαι πολύ Ευχαριστημένος.",
    rating: 5,
